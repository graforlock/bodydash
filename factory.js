...
eventList.subscribe(function() { onEvent(this.value);}) // Subscribes a function invoked on Custom Event 
	...
	return function(target) {
	        ...
	        xhr.onreadystatechange = function () {
	        	if(xhr.status == 200 && xhr.readyState == 4) {
	        		...
	        		return lens(extendData, function() { throw new Error('Getter Not Permitted')})
	        		.set(target,obj(json)), 
	        		trigger('fetched');
	        	}
